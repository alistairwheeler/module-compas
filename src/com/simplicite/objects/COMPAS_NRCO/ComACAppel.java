...
/**
 * Business object ComACAppel
 */
public class ComACAppel extends ComActionCommerciale {
	...
	public void initList(ObjectDB parent) {
		...
		if(isChildOf("ComClient") || isHomeInstance()){
			...
			setSearchSpec(getDefaultSearchSpec() + " and ac_type='APP'");
		}
